...
* (2.27) 的 trick 要多一点，为了方便，我用 $E$ 代替 $E\_{y\_0 | x\_0}E\_{\mathcal{T}}$
  ...
  根据上面一小节关于 (2.26) 中给出的 $\hat{y}\_0$ 的公式可知 $E(\hat{y}\_0) = \boldsymbol{x}\_0^T \beta$，所以 $Bias(\hat{y}\_0) = 0$。
  ...
  = & E(\sum\_i v\_i^2 \varepsilon\_i^2) (\because E(\varepsilon\_i \varepsilon\_j) = 0 \; if \; i \neq j \; \text{they are iid}) \\\\
